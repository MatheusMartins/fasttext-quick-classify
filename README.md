Before anything, the `.bin` model from fast-text must be downloaded - [here](https://fasttext.cc/docs/en/english-vectors.html) or [here](https://fasttext.cc/docs/en/crawl-vectors.html). 
